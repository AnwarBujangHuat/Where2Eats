...
const { selectAll, selectById, selectTotal } = restaurantAdapter.getSelectors(state => state);
export const getRestaurant = createSelector(state => state.restaurant.RESTAURANT,
  state => selectAll(state)
);
export const getCurrentRestaurant = (id) => createSelector(state => state.restaurant.RESTAURANT, state => selectById(state, id)
);
