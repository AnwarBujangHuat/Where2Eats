...
export const ModalScreen=({ navigation })=>
{
  ...
  setTimeout(()=>navigation.navigate(ConstString.HOME)
    ,2000)
  return(
    <SafeAreaView style={{ backgroundColor:Colors.secondaryPurple, justifyContent:'center'
      ,flex:1,alignItems:'center',alignContent:'center'}}>
      <LottieView style={{  height: width * .7,
        width: width * .7,}} source={Welcome} autoPlay={true}
      />
    </SafeAreaView>
  )
}
